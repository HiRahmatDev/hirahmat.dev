...
- Scroll controls in blog section

### Changed

- More responsive when filtering articles in "/articles" page
...
- Better layout and style of bottom sheet in "/lab/murajaah-at-taisir" page
...
- Better spacing on bottom sheet in "/lab/murajaah-at-taisir" page
...
- New `/lab/project-aidah` page (flagged off)
